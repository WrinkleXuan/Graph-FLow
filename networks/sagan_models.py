...
from networks.spectral import SpectralNorm
...
if __name__ == '__main__':
    ...
    #D_model = Discriminator(preprocess_GAN_mode=1,input_channel=3, batch_size=8, image_size=256)
    #D_model=PixelDiscriminator(3)
    D_model=NLayerDiscriminator(3,n_layers=3)
    img = torch.zeros((8,3,256,256))
    out = D_model(img)
    print(out.shape)