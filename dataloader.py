...
import h5py
__all__ = ['GastricCancerDataset','Synapsedataset', 'RandomResize', 'Resize', 'CenterCrop', 'RandomCrop', 'RandomHorizontalFlip', 'RandomVerticalFlip', 'ToTensor', 'Normalize','RandomGenerator']

class GastricCancerDataset(Dataset):
    def __init__(self, image_path="dataset/train", transform=None,type_image="patch"):
